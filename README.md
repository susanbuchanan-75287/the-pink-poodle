...
- **⚙️ Fees & PIN** — edit the checkout fee list, change the shared staff PIN (owner), set the **required-vaccine list** (manager+), and manage **per-stylist personal PINs & roles** (owner).
